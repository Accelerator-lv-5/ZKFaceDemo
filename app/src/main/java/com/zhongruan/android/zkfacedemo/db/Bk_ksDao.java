...
public class Bk_ksDao extends AbstractDao<Bk_ks, Long> {
    ...
    public static class Properties {
        ...
        public final static Property IsTG = new Property(12, String.class, "isTG", false, "isTG");
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Bk_ks entity) {
        ...
        String isTG = entity.getIsTG();
        if (isTG != null) {
            stmt.bindString(13, isTG);
        }
    }
    ...
    public Bk_ks readEntity(Cursor cursor, int offset) {
        Bk_ks entity = new Bk_ks( //
            ...
            cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12) // isTG
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Bk_ks entity, int offset) {
        ...
        entity.setIsTG(cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12));
     }
