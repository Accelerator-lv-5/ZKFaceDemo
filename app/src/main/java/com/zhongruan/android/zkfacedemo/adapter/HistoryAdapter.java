...
import com.zhongruan.android.zkfacedemo.ui.KWDJActivity;
import com.zhongruan.android.zkfacedemo.view.HistoryViw;
import com.zhongruan.android.zkfacedemo.view.UploadProgressBar;
...
public class HistoryAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        dataHolder.ll_xq_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, KWDJActivity.class);
                intent.putExtra("kcmc", DbServices.getInstance(context).selectKC().get(0).getKc_name());
                intent.putExtra("ccmc", DbServices.getInstance(context).selectCC().get(0).getCc_name());
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        viewHolder.mLlItemXqView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, KWDJActivity.class);
                intent.putExtra("ccmc", list_data.get(groupPosition).get(childPosition).getCc_mc());
                intent.putExtra("kcmc", list_data.get(groupPosition).get(childPosition).getKc_mc());
                context.startActivity(intent);
            }
        });
